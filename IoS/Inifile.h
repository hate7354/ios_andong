/*******************************************************************************************************************************
	...
	Date: June 15th, 2009
	Referance : http://www.codeproject.com/Articles/12914/INI-Reader-Writer-Class-for-MFC-and-ANSI-C-Windows
...
public:
    ...
    bool Load( const std::string& fileName , const std::string& section, const std::string& key, bool bMerge = false );

    // Load data from an input stream
    void Load( std::istream& input , const std::string& section, const std::string& key, bool bMerge = false );
...
public:
    ...
    public:
        ...
        void RemoveAllKeys( );
        // Returns a CIniKeyA pointer to the key by name, nullptr if it was not found
...
public:
    ...
    // Returns a CIniSectionA* to the section by name, nullptr if it was not found
...
public:
    ...
    public:
        ...
        // Removes all the keys in the section
        void RemoveAllKeys( );
        // Returns a CIniKeyW pointer to the key by name, nullptr if it was not found
...
public:
    ...
    // Removes all existing sections
    void RemoveAllSections( );
    // Returns a CIniSectionW* to the section by name, nullptr if it was not found
